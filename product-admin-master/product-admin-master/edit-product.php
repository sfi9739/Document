      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">ویرایش مقاله</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="edit.php" method="post" class="tm-edit-product-form">
                  <div class="form-group mb-3">
                    <label for="name">نام مقاله</label>
                    <input id="name"name="name"type="text"value="<?php echo $row['titel'];?>"class="form-control validate"/>
                  </div>
                  <div class="form-group mb-3">
                    <label for="pdate"> تاریخ ایجاد </label>
                    <input id="pdate"name="pdate"type="text"value="<?php echo $row['date'];?>"class="form-control validate"/>
                  </div>
                  <div class="form-group mb-3">
                    <label for="pcreator">سازنده  </label>
                    <input name="id" type="hidden" value="<?php echo $row['id']?>" />
                    <input id="pcreator"name="pcreator"type="text"value="<?php echo $row['creator'];?>"class="form-control validate"/>
                  </div>
                  <div class="form-group mb-3">
                    <label for="description">شرح</label>
                    <textarea name="description" class="form-control validate tm-small"rows="5"required><?php echo $row['content'];?></textarea>
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <select
                      ...
                      <option value="" selected> <?php echo $row['categuri'];?> </option>
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                <div class="tm-product-img-edit mx-auto">
                  <img src="<?php $image=$row['pic']; $s= substr($image,0); echo $s ?>" alt="Product image"  class="img-fluid d-block mx-auto">
                  <i
                ...
                <div class="custom-file mt-3 mb-3">
                  <!-- <input id="fileInput" type="file" name="pimage" style="" /> -->
                  <!-- <input type="file" name="pimage" class="btn btn-primary btn-block mx-auto">  -->
                  <input type="file" name="pimage"class="form-control"><br>
                  <!-- <input type="button" name="pimage" class="btn btn-primary btn-block mx-auto"value="اکنون تصویر را تغییر دهید"onclick="document.getElementById('fileInput').click();"/> -->
                </div>
              </div>
              <div class="col-12">
                <button type="submit" name="update" class="btn btn-primary btn-block text-uppercase">اکنون به روز رسانی کنید</button>
              </div>
            </form>
            </div>
          </div>
